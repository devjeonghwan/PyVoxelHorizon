...
class VoxelEditor:
    ...
    def __init__(self, game: Game):
        ...
        self.game_controller.get_voxel_object_with_grid_coord()

    def _get_voxel_object(self, x: int, y: int, z: int) -> VoxelObjectLite:
        vector3 = Vector3()
        vector3.x = x
        vector3.y = y
        vector3.z = z
    ...
    def set_voxel_color(self, x: int, y: int, z: int, color: VoxelColor) -> bool:
        ...
        return voxel_object.set_voxel_color_with_auto_resize(8, _align_voxel_coord(x), _align_voxel_coord(y),
                                                             _align_voxel_coord(z), color)
    ...
    def add_voxel(self, x: int, y: int, z: int, color: VoxelColor) -> bool:
        ...
        if not voxel_object:
            ...
            if not voxel_object.clear_and_add_voxel(_align_voxel_coord(x), _align_voxel_coord(y), _align_voxel_coord(z),
                                                    True):
                return False
        ...
        return voxel_object.add_voxel_with_auto_resize(8, _align_voxel_coord(x), _align_voxel_coord(y),
                                                       _align_voxel_coord(z), color)
    ...
    def remove_voxel(self, x: int, y: int, z: int) -> bool:
        ...
        if not voxel_object.remove_voxel_with_auto_resize(8, _align_voxel_coord(x), _align_voxel_coord(y),
                                                          _align_voxel_coord(z)):
            return False
