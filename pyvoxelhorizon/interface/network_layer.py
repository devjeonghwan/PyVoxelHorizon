...
FUNCTION_NETWORK_LAYER_SEND_MIDINOTEBLOCK = None
FUNCTION_NETWORK_LAYER_SEND_BEGINMIDINOTEBLOCK = None
FUNCTION_NETWORK_LAYER_SEND_ENDMIDINOTEBLOCK = None
...
def load_functions_of_network_layer(function_table_address: int):
    ...
    global FUNCTION_NETWORK_LAYER_SEND_MIDINOTEBLOCK
    FUNCTION_NETWORK_LAYER_SEND_MIDINOTEBLOCK = ctypes.CFUNCTYPE(None, wintypes.LPVOID, wintypes.LPVOID, wintypes.DWORD)(function_address)
    
    function_address = read_memory(function_table_address + 8, ctypes.c_void_p)
    global FUNCTION_NETWORK_LAYER_SEND_BEGINMIDINOTEBLOCK
    FUNCTION_NETWORK_LAYER_SEND_BEGINMIDINOTEBLOCK = ctypes.CFUNCTYPE(None, wintypes.LPVOID)(function_address)
    
    function_address = read_memory(function_table_address + 16, ctypes.c_void_p)
    global FUNCTION_NETWORK_LAYER_SEND_ENDMIDINOTEBLOCK
    FUNCTION_NETWORK_LAYER_SEND_ENDMIDINOTEBLOCK = ctypes.CFUNCTYPE(None, wintypes.LPVOID)(function_address)
...
class NetworkLayer(AddressObject):
    ...
    def send_midinoteblock(self, p_note_list: MidiNote, dw_note_num: int) -> None:
        p_note_list = get_address(p_note_list)
        
        return FUNCTION_NETWORK_LAYER_SEND_MIDINOTEBLOCK(self.address, p_note_list, dw_note_num)
    
    def send_beginmidinoteblock(self) -> None:
        
        return FUNCTION_NETWORK_LAYER_SEND_BEGINMIDINOTEBLOCK(self.address)
    
    def send_endmidinoteblock(self) -> None:
        
        return FUNCTION_NETWORK_LAYER_SEND_ENDMIDINOTEBLOCK(self.address)
