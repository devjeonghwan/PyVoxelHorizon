from pyvoxelhorizon import GameHook, GameController, NetworkLayer, AABB
...
class PyVoxelHorizonPluginLoader(GameHook):
    ...
    def on_start_scene(self, game_controller_address: int, network_layer_address: int, plugin_path: str):
        ...
        self.game_controller.get_world_info(
            ctypes.addressof(num_width),
            ctypes.addressof(num_depth),
            ctypes.addressof(num_height),
            ctypes.addressof(world_aabb),
        )
